...
{
    public class MaskAnnotationService
    {
        ...
        public bool IsPixelHit(LabelingSegmentationObject segment, Point imagePoint)
        {
            ...
            Func<LabelingSegmentationObject, bool> canEdit)
        {
            ...
            var segment = new LabelingSegmentationObject(Array.Empty<Point>(), classItem)
            {
                ...
                ZOrder = SegmentationZOrderService.GetNextZOrder(segments),
                RenderVersion = 1,
    ...
    [Obsolete("Use MaskAnnotationService.", false)]
    public sealed class WpfMaskAnnotationService : MaskAnnotationService
    {
    }
}
