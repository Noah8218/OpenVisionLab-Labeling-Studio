...
namespace MvcVisionSystem
{
    public class CandidateConfirmationService
    {
        ...
        public WpfCandidateConfirmationAttempt Prepare(
            CandidateReviewStateService state,
        ...
        public void ApplyConfirmation(CandidateReviewStateService state, WpfCandidateConfirmationPlan plan)
        {
    ...
    [Obsolete("Use CandidateConfirmationService.", false)]
    public sealed class WpfCandidateConfirmationService : CandidateConfirmationService
    {
    }
