...
{
    public class CandidateReviewStateService
    {
    ...
    [Obsolete("Use CandidateReviewStateService.", false)]
    public sealed class WpfCandidateReviewStateService : CandidateReviewStateService
    {
    }
