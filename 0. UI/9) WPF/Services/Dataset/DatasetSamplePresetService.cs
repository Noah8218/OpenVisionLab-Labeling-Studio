...
{
    public class DatasetSamplePresetApplyResult
    {
    ...
    public static class DatasetSamplePresetService
    {
        ...
        public static bool TryApplySample(
            ...
            out DatasetSamplePresetApplyResult result,
            out string error)
        {
            result = new DatasetSamplePresetApplyResult();
            error = string.Empty;
        ...
        private static bool TryApplyCoco128(LabelingProjectData data, out DatasetSamplePresetApplyResult result, out string error)
        {
            result = new DatasetSamplePresetApplyResult();
            error = string.Empty;
            ResolveCoco128Source(out string imageRoot, out string labelRoot);
        ...
        private static bool TryApplyIndustrialObjectDetectionImages(LabelingProjectData data, out DatasetSamplePresetApplyResult result, out string error)
        {
            result = new DatasetSamplePresetApplyResult();
            error = string.Empty;
        ...
        private static bool TryApplyIndustrialDefectMasks(LabelingProjectData data, out DatasetSamplePresetApplyResult result, out string error)
        {
            result = new DatasetSamplePresetApplyResult();
            error = string.Empty;
    ...
    [Obsolete("Use DatasetSamplePresetApplyResult.", false)]
    public sealed class WpfDatasetSamplePresetApplyResult : DatasetSamplePresetApplyResult
    {
        public WpfDatasetSamplePresetApplyResult()
        {
        }

        public WpfDatasetSamplePresetApplyResult(DatasetSamplePresetApplyResult source)
        {
            if (source == null)
            {
                return;
    ...
    [Obsolete("Use DatasetSamplePresetService.", false)]
    public static class WpfDatasetSamplePresetService
    {
        public static WpfDatasetSamplePresetItem CreateEmptyPreset(LabelingDatasetPurpose purpose)
            => DatasetSamplePresetService.CreateEmptyPreset(purpose);

        public static IReadOnlyList<WpfDatasetSamplePresetItem> BuildPresets(LabelingDatasetPurpose purpose)
            => DatasetSamplePresetService.BuildPresets(purpose);
        ...
        public static bool TryApplySample(
            ...
            out string error)
        {
            bool succeeded = DatasetSamplePresetService.TryApplySample(
                request,
                data,
                out DatasetSamplePresetApplyResult canonicalResult,
                out error);
            result = new WpfDatasetSamplePresetApplyResult(canonicalResult);
            return succeeded;
        }

        public static IReadOnlyList<string> GetDefaultClassNames(LabelingDatasetPurpose purpose)
            => DatasetSamplePresetService.GetDefaultClassNames(purpose);
    }
}
