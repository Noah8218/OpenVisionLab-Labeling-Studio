...
{
    public class DatasetSetupPathService
    {
        ...
        public string ResolveOutputRoot(string recipeName, string baseOutputRootPath, string recipeRootPath)
        {
            ...
            string normalizedRecipeName = ProjectRecipeService.IsValidRecipeName(recipeName)
                ? recipeName.Trim()
        ...
        public bool CanUseRecipeNameForNewDataset(string recipeName, string recipeRootPath)
        {
            ...
            string recipeDirectory = ProjectRecipeService.BuildConfigDirectory(recipeRootPath, recipeName.Trim());
            ...
            out string existingRecipeName)
        {
            ...
            foreach (string recipeName in ProjectRecipeService.ListRecipeNames(recipeRootPath))
            {
    ...
    [Obsolete("Use DatasetSetupPathService.", false)]
    public sealed class WpfDatasetSetupPathService : DatasetSetupPathService
    {
    }
}
