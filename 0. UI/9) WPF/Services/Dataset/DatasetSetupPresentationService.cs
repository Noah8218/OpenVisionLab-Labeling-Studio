...
{
    public class DatasetSetupPresentationService
    {
        ...
        public string BuildReadyStatus(
            ...
            string manifestPath,
            DatasetSamplePresetApplyResult sampleResult)
        {
    ...
    [Obsolete("Use DatasetSetupPresentationService.", false)]
    public sealed class WpfDatasetSetupPresentationService : DatasetSetupPresentationService
    {
    }
}
