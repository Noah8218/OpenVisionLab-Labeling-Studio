...
{
    public class DetectionResultPresentationService
    {
    ...
    [Obsolete("Use DetectionResultPresentationService.", false)]
    public sealed class WpfDetectionResultPresentationService : DetectionResultPresentationService
    {
    }
}
