...
{
    public class DetectionWorkerCompletionWaiter : IDisposable
    {
        ...
        public DetectionWorkerCompletionWaiter(
    ...
    [Obsolete("Use DetectionWorkerCompletionWaiter.", false)]
    public sealed class WpfDetectionWorkerCompletionWaiter : DetectionWorkerCompletionWaiter
    {
        public WpfDetectionWorkerCompletionWaiter(
            DetectionResultApplicationService detectionResults,
            string imagePath,
            CancellationToken cancellationToken)
            : base(detectionResults, imagePath, cancellationToken)
        {
        }
    }
}
