...
{
    public class ImageLoadPresentationService
    {
    ...
    [Obsolete("Use ImageLoadPresentationService.", false)]
    public sealed class WpfImageLoadPresentationService : ImageLoadPresentationService
    {
    }
}
