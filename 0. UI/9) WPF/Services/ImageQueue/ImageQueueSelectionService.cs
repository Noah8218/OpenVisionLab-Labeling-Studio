...
{
    public class ImageQueueOpenSelection
    {
    ...
    [Obsolete("Use ImageQueueOpenSelection.", false)]
    public sealed class WpfImageQueueOpenSelection : ImageQueueOpenSelection
    {
    }

    public class ImageQueueSelectionService
    {
        ...
        public ImageQueueOpenSelection ResolveOpenSelection(IEnumerable<WpfImageQueueItem> candidates, LabelingProjectData data)
        {
            foreach (WpfImageQueueItem candidate in candidates ?? Array.Empty<WpfImageQueueItem>())
            {
                ...
                {
                    return new ImageQueueOpenSelection
                    {
                        Item = candidate,
    ...
    [Obsolete("Use ImageQueueSelectionService.", false)]
    public sealed class WpfImageQueueSelectionService : ImageQueueSelectionService
    {
        public new WpfImageQueueOpenSelection ResolveOpenSelection(IEnumerable<WpfImageQueueItem> candidates, LabelingProjectData data)
        {
            ImageQueueOpenSelection selection = base.ResolveOpenSelection(candidates, data);
            return new WpfImageQueueOpenSelection
            {
                Item = selection.Item,
                OpenImagePath = selection.OpenImagePath
            };
        }
    }
}
