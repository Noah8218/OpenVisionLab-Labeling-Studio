...
{
    public static class ObjectReviewEditService
    {
    ...
    [Obsolete("Use ObjectReviewEditService.", false)]
    public static class WpfObjectReviewEditService
    {
        public static string NormalizeClassName(string className)
            => ObjectReviewEditService.NormalizeClassName(className);
        ...
        public static string GetClassName(
            ...
            IReadOnlyList<LabelingSegmentationObject> manualSegments,
            IReadOnlyList<YoloWorkerSmokeCandidate> confirmedCandidates)
            => ObjectReviewEditService.GetClassName(item, manualClassNames, manualSegments, confirmedCandidates);
        ...
        public static bool TryApplyClass(
            ...
            out string normalizedClassName,
            LabelClass classItem = null)
            => ObjectReviewEditService.TryApplyClass(
                item,
                manualRois,
                manualClassNames,
                manualSegments,
        ...
        public static bool TryDelete(
            ...
            IList<LabelingSegmentationObject> manualSegments,
            IList<YoloWorkerSmokeCandidate> confirmedCandidates)
            => ObjectReviewEditService.TryDelete(item, manualRois, manualClassNames, manualSegments, confirmedCandidates);
    }
