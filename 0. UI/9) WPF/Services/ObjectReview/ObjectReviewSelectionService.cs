...
{
    public static class ObjectReviewSelectionService
    {
    ...
    [Obsolete("Use ObjectReviewSelectionService.", false)]
    public static class WpfObjectReviewSelectionService
    {
        public static bool TryResolveSelectedItem(
            ...
            int manualRoiCount,
            out WpfObjectReviewItemRef item)
            => ObjectReviewSelectionService.TryResolveSelectedItem(selectedObject, manualOverlayIds, manualRoiCount, out item);

        public static WpfObjectReviewItemRef ResolveItem(
            WpfObjectReviewItemRef item,
            IReadOnlyList<string> manualOverlayIds,
            int manualRoiCount)
            => ObjectReviewSelectionService.ResolveItem(item, manualOverlayIds, manualRoiCount);

        public static int ResolveManualRoiIndex(
            WpfObjectReviewItemRef item,
            IReadOnlyList<string> manualOverlayIds,
            int manualRoiCount)
            => ObjectReviewSelectionService.ResolveManualRoiIndex(item, manualOverlayIds, manualRoiCount);

        public static int FindManualRoiIndexByOverlayId(IReadOnlyList<string> manualOverlayIds, string overlayId)
            => ObjectReviewSelectionService.FindManualRoiIndexByOverlayId(manualOverlayIds, overlayId);

        public static string GetManualRoiOverlayId(IReadOnlyList<string> manualOverlayIds, int index)
            => ObjectReviewSelectionService.GetManualRoiOverlayId(manualOverlayIds, index);

        public static bool IsSource(WpfObjectReviewListItem item, WpfObjectReviewSource source)
            => ObjectReviewSelectionService.IsSource(item, source);

        public static int GetSelectedRowIndex(IList<WpfObjectReviewListItem> objects, WpfObjectReviewListItem selected)
            => ObjectReviewSelectionService.GetSelectedRowIndex(objects, selected);

        public static bool CanReplaceManualRoiRow(
            IList<WpfObjectReviewListItem> objects,
            int manualRoiIndex,
            int manualRoiCount)
            => ObjectReviewSelectionService.CanReplaceManualRoiRow(objects, manualRoiIndex, manualRoiCount);
        ...
        public static bool ShouldUseIncrementalDelete(
            ...
            int deletedObjectRowIndex,
            int currentObjectRowCount)
            => ObjectReviewSelectionService.ShouldUseIncrementalDelete(
                deletedSource,
        ...
        public static int GetSelectionIndexAfterDelete(int deletedObjectRowIndex, int remainingObjectRowCount)
            => ObjectReviewSelectionService.GetSelectionIndexAfterDelete(deletedObjectRowIndex, remainingObjectRowCount);
    }
}
