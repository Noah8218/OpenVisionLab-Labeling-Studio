...
namespace MvcVisionSystem
{
    ...
    public partial class WpfLabelingShellWindow
    {
        ...
        private async Task ExecuteRunSegmentationAdapterComparisonCommandAsync()
        {
            ...
            SegmentationAdapterComparisonRunRequest request = segmentationAdapterComparisonRunService.BuildRequest(
                global.Data,
                global.Data.ProjectSettings.PythonModel,
            ...
            segmentationAdapterComparisonCts = cancellation;
            ...
            try
            {
                SegmentationAdapterComparisonRunResult result = await segmentationAdapterComparisonRunService
            ...
            {
                if (ReferenceEquals(segmentationAdapterComparisonCts, cancellation))
                {
