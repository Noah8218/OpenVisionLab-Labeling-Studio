...
{
    /// <summary>
    /// Owns the Python model client communication/process references and their
    /// start, stop, restart, and readiness lifecycle.
    /// </summary>
    public sealed class ModelRuntimeClientLifecycle
    {
        ...
        public ModelRuntimeClientLifecycle(
