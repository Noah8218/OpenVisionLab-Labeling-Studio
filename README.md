...
1. 박스 기반 MobileSAM 스마트 마스크는 8개 합성 결함 클래스의 고정 24표본 평가까지 완료했습니다. 점·음성 프롬프트는 실제 사용에서 박스만으로 부족한 사례가 재현될 때만 확장합니다.
...
- MobileSAM은 현재 단일 박스 프롬프트와 사람의 후보 확정만 지원합니다. 8개 클래스 평가는 정확한 메타데이터 박스 조건이며, 대략적인 사용자 박스 내성을 보장하지 않습니다. 자동 확정, 점/음성 프롬프트와 텍스트 기반 자동 라벨링은 지원하지 않습니다.
