...
$annotationTestLog = Join-Path $logDir "verify-wpf-annotation-objects-focused-tests-$stamp.log"
$visualLog = Join-Path $logDir "verify-wpf-annotation-objects-focused-visual-$stamp.log"
$visualPng = Join-Path $uiDir "verify-wpf-annotation-objects-focused-$stamp.png"
...
try {
    ...
    Write-Host "Tests     : $annotationTestLog"
